...
//================================================定义 MT9V03X 参数配置================================================
#define MT9V03X_W               (188)            //默认188                               // 图像宽度     范围 [1-752]   参考值 80
#define MT9V03X_H               (120)            //默认120                               // 图像高度     范围 [1-480]   参考值 60或120

#define MT9V03X_IMAGE_SIZE      (MT9V03X_W * MT9V03X_H)                         // 整体图像大小不能超过 65535

#define MT9V03X_AUTO_EXP_DEF    ( 50   )  //光线越强数值越大，一般室内取30以下                                       // 自动曝光设置     默认不开启自动曝光设置  范围 [0-63] 0为关闭
...
#define MT9V03X_FPS_DEF         ( 100  )    //默认50                                     // 图像帧率         摄像头收到后会自动计算出最大FPS，如果过大则设置为计算出来的最大FPS
...
#define MT9V03X_UD_OFFSET_DEF   ( 0   )                                         // 图像上下偏移量   正值 上偏移   负值 下偏移  行为120 240 480时无法设置偏移
                                                                                //                  摄像头收偏移数据后会自动计算最大偏移，如果超出则设置计算出来的最大偏移
#define MT9V03X_GAIN_DEF        ( 32  )   //默认32                                      // 图像增益         范围 [16-64]  增益可以在曝光时间固定的情况下改变图像亮暗程度
