...
void MotorInit(void)
{
    gpio_init(P21_5, GPO, 0, GPO_PUSH_PULL);//电机2dir
    gpio_init(P21_3, GPO, 0, GPO_PUSH_PULL);//电机1dir
    pwm_init(ATOM0_CH0_P21_2,300,0);//电机1
    pwm_init(ATOM1_CH2_P21_4,300,0);//电机2
